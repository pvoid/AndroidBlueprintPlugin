...
val ANDROID_TEST_FIELDS = listOf(
    ...
    BlueprintReferenceField("certificate", "The name of a certificate in the default certificate directory, blank to use the default product certificate, or an android_app_certificate module name in the form \":module\"."),
    ...
    BlueprintStringListField("data", "list of files or filegroup modules that provide data that should be installed alongside the test"),
    BlueprintReferencesListField("defaults", ""),
    ...
    BlueprintObjectField("optimize", "", listOf(
        ...
        BlueprintBooleanField("enabledByDefault", "True if the module containing this has it set by default. Default: true"),
    ...
    BlueprintObjectField("target", "", listOf(
        ...
        BlueprintObjectField("hostdex", "", listOf(
            BlueprintStringListField("required", "Additional required dependencies to add to -hostdex modules."),
        )),
    )),
    ...
    BlueprintStringField("test_config", "the name of the test configuration (for example \"AndroidTest.xml\") that should be installed with the module."),
    BlueprintStringField("test_config_template", "the name of the test configuration template (for example \"AndroidTestTemplate.xml\") that should be installed with the module."),
    BlueprintStringListField("test_suites", "list of compatibility suites (for example \"cts\", \"vts\") that the module should be installed into."),
