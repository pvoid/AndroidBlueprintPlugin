...
val ANDROID_APP_CERTIFICATE_FIELDS = listOf(
    BlueprintStringField("name", "The name of the module. Must be unique across all modules."),
    BlueprintStringField("certificate", "Name of the certificate files. Extensions .x509.pem and .pk8 will be added to the name."),
