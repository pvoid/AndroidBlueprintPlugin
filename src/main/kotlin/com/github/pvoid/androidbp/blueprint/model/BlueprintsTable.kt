...
interface BlueprintChangeNotifier {
    ...
    companion object {
        val CHANGE_TOPIC = Topic.create<BlueprintChangeNotifier>("Blueprint file changed", BlueprintChangeNotifier::class.java)
    }
}
...
class BlueprintsTableImpl : BlueprintsTable {
    ...
    override fun update(project: Project, blueprintFiles: List<VirtualFile>) {
        ProgressManager.getInstance()
            .run(object : Task.Backgroundable(project, "Updating cached blueprints...", false) {
