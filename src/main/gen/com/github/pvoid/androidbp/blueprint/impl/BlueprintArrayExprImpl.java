...
public class BlueprintArrayExprImpl extends ASTWrapperPsiElement implements BlueprintArrayExpr {

  public BlueprintArrayExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BlueprintArray> getArrayList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BlueprintArray.class);
  }
