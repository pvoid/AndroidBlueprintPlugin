...
public class BlueprintVariableRefExprImpl extends ASTWrapperPsiElement implements BlueprintVariableRefExpr {

  public BlueprintVariableRefExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BlueprintValue getValue() {
    return findChildByClass(BlueprintValue.class);
  }
