...
public class BlueprintElementsImpl extends ASTWrapperPsiElement implements BlueprintElements {

  public BlueprintElementsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BlueprintArrayElement> getArrayElementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BlueprintArrayElement.class);
  }
