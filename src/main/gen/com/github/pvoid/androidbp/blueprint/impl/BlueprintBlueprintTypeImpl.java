...
public class BlueprintBlueprintTypeImpl extends ASTWrapperPsiElement implements BlueprintBlueprintType {

  public BlueprintBlueprintTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BlueprintVisitor visitor) {
    visitor.visitBlueprintType(this);
  }
