...
public class BlueprintArrayElementImpl extends ASTWrapperPsiElement implements BlueprintArrayElement {

  public BlueprintArrayElementImpl(@NotNull ASTNode node) {
    super(node);
  }
